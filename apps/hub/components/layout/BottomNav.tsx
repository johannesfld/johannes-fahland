  ...
  return (
    ...
    >
      <div className="flex items-stretch">
          ...
          >
            {items.map((item) => {
              ...
              return (
                ...
                >
                  {active && (
                    <span className="absolute top-0 left-1/2 -translate-x-1/2 h-[3px] w-8 rounded-b-full bg-[var(--brand-500)]" />
                  )}
                  <item.icon
                    size={20}
                    aria-hidden
        ...
        <div className="flex shrink-0 items-center border-l border-[var(--vibe-line)] px-2">
