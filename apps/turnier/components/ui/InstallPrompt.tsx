  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="shrink-0 rounded-[var(--vibe-r-md)] bg-[var(--accent)] px-3 py-1.5 text-xs font-semibold text-[var(--accent-ink)] shadow-[var(--vibe-shadow-soft)] transition-all hover:brightness-110 active:scale-[0.98]"
      >
        Installieren
      </button>
    </div>
